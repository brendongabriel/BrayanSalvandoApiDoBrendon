...
public class PessoaAssembler {
    ...
    public Pessoa toEntity(PessoaInputLoginDTO pessoaInputLoginDTO){
        return modelMapper.map(pessoaInputLoginDTO, Pessoa.class);
    }
    ...
    public PessoaLoginDTO toModelLogin(Pessoa pessoa) {
